        ...
        <div className="container">
          <article className="max-w-3xl mx-auto prose prose-slate dark:prose-invert">
            ...
            <section className="mb-10">
              ...
              <h3 className="text-xl font-semibold text-foreground mt-6 mb-3">Strategy = How extra money is applied</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section className="mb-10">
              ...
              <h3 className="text-xl font-semibold text-foreground mt-6 mb-3">Debts Tab – Detailed Walkthrough</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-foreground mb-4">Order Tab</h2>
              <p className="text-muted-foreground leading-relaxed">
                The Order tab shows the exact sequence in which debts will be paid based on your selected strategy.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                You can visually confirm which debt is currently targeted and how others will follow.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                For custom strategies, this tab allows ranking and manual adjustments.
              </p>
            </section>
            ...
            <section className="mb-10">
              ...
              <h3 className="text-xl font-semibold text-foreground mt-6 mb-3">Budget Tab – Detailed Walkthrough</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            {/* Accounts Section */}
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-foreground mb-4">Accounts Section</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-foreground mb-4">Bills & Payments Section</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            {/* How the Budget Tab Impacts the Overall App */}
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-foreground mb-4">How the Budget Tab Impacts the Overall App</h2>
              <ul className="space-y-2 text-muted-foreground">
            ...
            <section className="mb-10">
              ...
              <h3 className="text-xl font-semibold text-foreground mt-6 mb-3">Sync Tab – Export & Import (Manual Sync)</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            {/* Export Debt Data */}
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-foreground mb-4">Export Debt Data</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            {/* Export Budget Data */}
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-foreground mb-4">Export Budget Data</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            {/* Import Debts */}
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-foreground mb-4">Import Debts</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            {/* Import Accounts */}
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-foreground mb-4">Import Accounts</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            {/* Import Bills */}
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-foreground mb-4">Import Bills</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            {/* How the Sync Tab Impacts the Overall App */}
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-foreground mb-4">How the Sync Tab Impacts the Overall App</h2>
              <ul className="space-y-2 text-muted-foreground">
